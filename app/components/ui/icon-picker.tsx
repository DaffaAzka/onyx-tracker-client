    ...
    return (
      <Popover
        ...
        <PopoverContent className="w-72 p-3">
          ...
          <div
            ref={parentRef}
            className="max-h-60 overflow-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-foreground/20 [&::-webkit-scrollbar-thumb]:rounded-full"
            style={{
              scrollbarWidth: "thin",
